# examination_1
Om projektet:
En fiktiv sida om en typ spel mässa som är skapt med HTML och CSS. Gjord på egen hand då gruppen vart som den vart. Highlights bilderna tagna från pixabay.com, Färger tagna från colorhunt.co.
